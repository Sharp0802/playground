...
namespace Probo::Motor
{
	...
	template<> struct DCMotorMethodGetter<1> { static constexpr void (*Setter)(signed char) = motor1; };

	template<> struct DCMotorMethodGetter<2> { static constexpr void (*Setter)(signed char) = motor2; };

	template<> struct DCMotorMethodGetter<3> { static constexpr void (*Setter)(signed char) = motor3; };

	template<> struct DCMotorMethodGetter<4> { static constexpr void (*Setter)(signed char) = motor4; };
